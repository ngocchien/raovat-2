...
//        shell_exec("nohup php " . PUBLIC_PATH . "/index.php sitemap >/dev/null & echo 2>&1 & echo $!");
    ...
    public function testAction()
    {
        ...
        for ($i = 0; $i < 100000000; $i++) {
            $url = 'http://t.ants.vn/a1/ti/?bc=d915a32176,1481690503470,' . time() . ',2917651110,1,582556638,574163694,574163696,50284,1,582556777,582556767,1,0_1&t_s=582556638-582556777-574163696:1&t_z=&t_tp=&t_itr=&t_imk=&t_rm=&c_tp=7:0.45355,46:0.03825,51:0.01639&c_itr=73:0.76,36:0.28,32:0.15&c_imk=24363:7.80,20713:0.02,20739:0.08&c_rm=&timestamp=1481690508925&url=http%3A%2F%2Ftrungants.freevnn.com%2Fnews.html&urlref=&hostname=trungants.freevnn.com&format=12&template=0&res=1366x768&pos=5&resfl=237:597_237:597&gd=3&loc=29-1-vn&t2t=1311';
            General::crawler($url);
            echo \My\General::getColoredString('Request Insert True-Impression ' . $i, 'yellow');
            $this->flush();
        }
